# Load Balancing
## Membuat Program Load Balancing
- Buat file topo_lb.py
```sh
nano topo_lb.py
```
- Masukkan Kode Program dibawah
```python
...
```
- Jalankan mininet dengan program topo_lb.py:
```sh
sudo python3 topo_lb.py
```
- Jalankan aplikasi rr_lb.py pada Ryu controller menggunakan `ryu-manager` pada terminal lainnya:
```sh
